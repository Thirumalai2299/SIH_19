...
destlatlng=new LatLng(11.0202,76.9345);
        currentlatlng =new LatLng(85.8024,85.8024);
        ...
        btn = (Button) view.findViewById(R.id.gobtn);
        btn.setOnClickListener(new View.OnClickListener() {
           ...
           //     currentlatlng = new LatLng(lastLocation.getLatitude(), lastLocation.getLongitude());
            /*    MarkerOptions markerOptions = new MarkerOptions();
                ...
                getRouteToMarker(currentlatlng);
        ...
        if (!Places.isInitialized()) {
            Places.initialize(getContext(), "AIzaSyDxriqq1EF6lpBjCs9SH1b8hQJGl1GPAJg");
        }
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
           ...
           //     destination = place.getName();
            //    destlatlng = place.getLatLng();
               // Log.i("HAIII", place.getLatLng().toString());
...
/*
    ...
    public void markerLocation(LatLng latLng) {
        Log.i(TAG, "markerLocation(" + latLng + ")");
        String title = latLng.longitude + ", " + latLng.longitude;
        MarkerOptions markerOptions = new MarkerOptions()
                .position(latLng)
                .title(title);
        if (map != null) {
