...
import com.example.indreshprakash.testing.OnButtonSwitchedListener;
       ...
       animator.setInterpolator(new AccelerateInterpolator());
        animator.addUpdateListener(animation -> {
            ...
            if (isLogin) {
                ...
                loginPaint.setAlpha((int) (255 - 255 * fraction)); // fade out login1 large text
            }
            ...
            // move login1 text to center and scale
            if (isLogin) {
