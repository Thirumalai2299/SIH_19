...
public class shopmall extends AppCompatActivity
    ...
    private void collectlatlon(Map<String,Object> blackspot) {
        ...
        Toast.makeText(shopmall.this,"Nearby Shopping Mall's", Toast.LENGTH_LONG).show();
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyDxriqq1EF6lpBjCs9SH1b8hQJGl1GPAJg");
