...
public class route extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Places.initialize(getApplicationContext(), "AIzaSyDxriqq1EF6lpBjCs9SH1b8hQJGl1GPAJg");
...
//                mMap.animateCamera(CameraUpdateFactory.zoomTo(11));
    ...
    private String getUrl(LatLng origin, LatLng dest) {
        ...
        String url = "https://maps.googleapis.com/maps/api/directions/" + output + "?" + parameters +"&key=AIzaSyDxriqq1EF6lpBjCs9SH1b8hQJGl1GPAJg";
